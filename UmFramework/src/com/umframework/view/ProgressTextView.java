 ...
 * android 分段显示文本颜色控件
 * 
 * <com.umframework.view.ProgressTextView
 * xmlns:ptv="http://schemas.android.com/apk/res-auto" android:text="学习计划课程"
 * android:background="#000000" android:layout_width="200px"
 * android:layout_height="100px" ptv:progress="0.6" />
 * 
...
public class ProgressTextView extends TextView
{
	...
	public ProgressTextView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		// progress =
		// colorTa.getFloat(R.styleable.ProgressTextView_textProgress, 0.1f);
		colorTa.recycle();
	}
	...
	protected void onDraw(Canvas canvas)
	{
		...
		canvas.drawText(getText(), reachTextLength, getText().length(), startX + getPaint().measureText(reachText), (sizeHeight) / 2.0f + textBounds.height() / 2f, mUnreachedTextPaint);
	}
