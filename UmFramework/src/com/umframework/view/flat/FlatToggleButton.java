...
public class FlatToggleButton extends ToggleButton implements Attributes.AttributeChangeListener
{
	...
	private void init(AttributeSet attrs)
	{
		...
		Drawable[] d1 =
		{ uncheckedEnabledBack, uncheckedEnabledFront };
		...
		Drawable[] d2 =
		{ checkedEnabledBack, checkedEnabledFront };
		...
		Drawable[] d3 =
		{ uncheckedDisabledBack, uncheckedDisabledFront };
		...
		Drawable[] d4 =
		{ checkedDisabledBack, checkedDisabledFront };
		LayerDrawable checkedDisabled = new LayerDrawable(d4);

		StateListDrawable states = new StateListDrawable();

		states.addState(new int[]
		{ -android.R.attr.state_checked, android.R.attr.state_enabled }, new InsetDrawable(uncheckedEnabled, padding * 2));
		states.addState(new int[]
		{ android.R.attr.state_checked, android.R.attr.state_enabled }, new InsetDrawable(checkedEnabled, padding * 2));
		states.addState(new int[]
		{ -android.R.attr.state_checked, -android.R.attr.state_enabled }, new InsetDrawable(uncheckedDisabled, padding * 2));
		states.addState(new int[]
		{ android.R.attr.state_checked, -android.R.attr.state_enabled }, new InsetDrawable(checkedDisabled, padding * 2));
