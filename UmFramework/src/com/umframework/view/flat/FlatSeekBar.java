...
public class FlatSeekBar extends SeekBar implements Attributes.AttributeChangeListener
{
	...
	private void init(AttributeSet attrs)
	{
		...
		if (attrs != null)
		{
			TypedArray a = getContext().obtainStyledAttributes(attrs, com.umframework.R.styleable.fl_FlatSeekBar);

			// getting common attributes
			int customTheme = a.getResourceId(com.umframework.R.styleable.fl_FlatSeekBar_fl_theme, Attributes.DEFAULT_THEME);
			attributes.setThemeSilent(customTheme, getResources());

			attributes.setSize(a.getDimensionPixelSize(com.umframework.R.styleable.fl_FlatSeekBar_fl_size, Attributes.DEFAULT_SIZE_PX));
