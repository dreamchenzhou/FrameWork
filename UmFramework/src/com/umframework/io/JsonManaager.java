...
public final class JsonManaager
{
	 ...
	 * @since 1.0
	 */
	public static <T> T fromJson(String json, Class<T> clazz, String datePattern, boolean dotNet)
	{
		if (isBlankString(json))
		{
			return null;
	 ...
	 * @since 1.0
	 */
	public static <T> T fromJson(String json, Class<T> clazz, boolean dotNet)
	{
		return fromJson(json, clazz, null, dotNet);
	}
}