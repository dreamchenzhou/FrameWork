...
public class FlatCheckBox extends CheckBox implements Attributes.AttributeChangeListener
{
	...
	private void init(AttributeSet attrs)
	{
		...
		InsetDrawable checkedInside = new InsetDrawable(checkedCore, attributes.getBorderWidth() + dotMargin, attributes.getBorderWidth() + dotMargin, attributes.getBorderWidth() + dotMargin,
		...
		InsetDrawable checkedInsideDisabled = new InsetDrawable(checkedCoreDisabled, attributes.getBorderWidth() + dotMargin, attributes.getBorderWidth() + dotMargin, attributes.getBorderWidth()
				+ dotMargin, attributes.getBorderWidth() + dotMargin);
		...
		{ -android.R.attr.state_checked, android.R.attr.state_enabled }, uncheckedEnabled);
		states.addState(new int[]
		{ android.R.attr.state_checked, android.R.attr.state_enabled }, checkedEnabled);
		states.addState(new int[]
		{ -android.R.attr.state_checked, -android.R.attr.state_enabled }, uncheckedDisabled);
		states.addState(new int[]
		{ android.R.attr.state_checked, -android.R.attr.state_enabled }, checkedDisabled);
