...
public class FlatUI
{
	...
	/**
	 * Converts the default values to dp to be compatible with different screen
	 * sizes
	 * 
	 * @param context
	 */
	...
	public static Typeface getFont(Context context, Attributes attributes)
	{
		...
		{
			Log.e("FlatUI", "Font file at " + fontPath + " cannot be found or the file is " + "not a valid font file. Please be sure that library assets are included "
