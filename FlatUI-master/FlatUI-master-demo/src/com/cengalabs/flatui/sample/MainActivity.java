...
public class MainActivity extends Activity // ActionBarActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Spinner spinner2 = (Spinner) findViewById(R.id.themes_spinner2);
		...
		int textViewResourceId = android.R.layout.select_dialog_item;
		int resource = android.R.layout.simple_list_item_checked;

		ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(this, textViewResourceId, objects);
		adapter2.setDropDownViewResource(resource);
